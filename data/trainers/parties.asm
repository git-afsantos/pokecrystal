...
FalknerGroup:
	...
	db 50, NOCTOWL,  LEFTOVERS,  HYPNOSIS, REFLECT, NIGHT_SHADE, REST
	db 50, MURKROW,  LEFTOVERS,  DRILL_PECK, FAINT_ATTACK, PURSUIT, NIGHT_SHADE
	db 50, SKARMORY, LEFTOVERS,  WHIRLWIND, DRILL_PECK, REST, CURSE
	db 50, PIDGEOT,  LEFTOVERS,  RETURN, WING_ATTACK, STEEL_WING, MIRROR_MOVE
	db 50, FEAROW,   MINT_BERRY, REST, SLEEP_TALK, DOUBLE_EDGE, DRILL_PECK
	db 50, DODRIO,   LEFTOVERS,  DOUBLE_EDGE, DRILL_PECK, REST, SLEEP_TALK
	db -1 ; end
...
BugsyGroup:
	...
	db "BUGSY@"
	; TRAINERTYPE_ITEM_MOVES
	db 50, SCIZOR, MIRACLEBERRY, SWORDS_DANCE, BATON_PASS, STEEL_WING, AGILITY
	db 50, HERACROSS, LEFTOVERS, REST, SLEEP_TALK, MEGAHORN, SEISMIC_TOSS
	db 50, PINSIR, LEFTOVERS, SWORDS_DANCE, FURY_CUTTER, BODY_SLAM, SUBMISSION
	db 50, FORRETRESS, LEFTOVERS, SPIKES, RAPID_SPIN, TOXIC, EXPLOSION
	db 50, SHUCKLE, LEFTOVERS, SANDSTORM, TOXIC, REST, WRAP
	db 50, BEEDRILL, LEFTOVERS, SLUDGE_BOMB, SWORDS_DANCE, TWINEEDLE, AGILITY
	db -1 ; end
...
WhitneyGroup:
	...
	db "WHITNEY@"
	; TRAINERTYPE_ITEM_MOVES
	db 50, SMEARGLE, MIRACLEBERRY, SPORE, AGILITY, BATON_PASS, SPIKES
	db 50, GRANBULL, LEFTOVERS, REST, SLEEP_TALK, RETURN, SHADOW_BALL
	db 50, MILTANK,  LEFTOVERS, HEAL_BELL, MILK_DRINK, GROWL, BODY_SLAM
	db 50, CLEFABLE, LEFTOVERS, BELLY_DRUM, MOONLIGHT, RETURN, FIRE_BLAST
	db 50, BLISSEY,  LEFTOVERS, HEAL_BELL, FLAMETHROWER, TOXIC, SOFTBOILED
	db 50, URSARING, LEFTOVERS, CURSE, RETURN, EARTHQUAKE, ROAR
	db -1 ; end
...
MortyGroup:
	...
	db "MORTY@"
	; TRAINERTYPE_ITEM_MOVES
	db 50, GENGAR, LEFTOVERS, THUNDERBOLT, ICE_PUNCH, HYPNOSIS, EXPLOSION
	db 50, GENGAR, LEFTOVERS, THUNDER, ICE_PUNCH, DYNAMICPUNCH, DESTINY_BOND
	db 50, GENGAR, LEFTOVERS, PERISH_SONG, MEAN_LOOK, PROTECT, THUNDERBOLT
	db 50, MISDREAVUS, NO_ITEM, THUNDER, TOXIC, THIEF, PAIN_SPLIT
	db 50, MISDREAVUS, LEFTOVERS, THUNDER, TOXIC, PROTECT, PAIN_SPLIT
	db 50, MISDREAVUS, LEFTOVERS, MEAN_LOOK, PERISH_SONG, PROTECT, CONFUSE_RAY
	db -1 ; end
...
ChuckGroup:
	...
	db "CHUCK@"
	; TRAINERTYPE_ITEM_MOVES
	db 50, PRIMEAPE, LEFTOVERS, CROSS_CHOP, ROCK_SLIDE, MEDITATE, SUBSTITUTE
	db 50, POLIWRATH, LEFTOVERS, BELLY_DRUM, LOVELY_KISS, HYDRO_PUMP, BODY_SLAM
	db 50, MACHAMP, LEFTOVERS, CROSS_CHOP, CURSE, ROCK_SLIDE, FIRE_BLAST
	db 50, MACHAMP, LEFTOVERS, CROSS_CHOP, ROCK_SLIDE, EARTHQUAKE, BODY_SLAM
	db 50, HERACROSS, LEFTOVERS, REST, SLEEP_TALK, MEGAHORN, SEISMIC_TOSS
	db 50, HITMONTOP, LEFTOVERS, HI_JUMP_KICK, REST, COUNTER, RAPID_SPIN
	db -1 ; end
...
JasmineGroup:
	...
	db "JASMINE@"
    ; TRAINERTYPE_ITEM_MOVES
	db 50, MAGNETON, LEFTOVERS, THUNDERBOLT, SUBSTITUTE, REFLECT, THUNDER_WAVE
	db 50, STEELIX, LEFTOVERS, EARTHQUAKE, CURSE, ROAR, EXPLOSION
	db 50, STEELIX, LEFTOVERS, IRON_TAIL, CURSE, ROAR, SUBSTITUTE
	db 50, FORRETRESS, LEFTOVERS, SPIKES, RAPID_SPIN, TOXIC, EXPLOSION
	db 50, SCIZOR, MIRACLEBERRY, SWORDS_DANCE, BATON_PASS, STEEL_WING, AGILITY
	db 50, SKARMORY, LEFTOVERS,  WHIRLWIND, DRILL_PECK, REST, CURSE
	db -1 ; end
...
PryceGroup:
	...
	db "PRYCE@"
	; TRAINERTYPE_ITEM_MOVES
	db 50, DEWGONG,    LEFTOVERS, HEADBUTT, ICY_WIND, AURORA_BEAM, REST
	db 50, PILOSWINE,  LEFTOVERS, ICY_WIND, FURY_ATTACK, MIST, BLIZZARD
	db -1 ; end
...
ClairGroup:
	...
	db "CLAIR@"
	; TRAINERTYPE_ITEM_MOVES
	db 50, DRAGONAIR, LEFTOVERS, THUNDER_WAVE, SURF, SLAM, DRAGONBREATH
	db 50, DRAGONAIR, LEFTOVERS, THUNDER_WAVE, THUNDERBOLT, SLAM, DRAGONBREATH
	db 50, DRAGONAIR, LEFTOVERS, THUNDER_WAVE, ICE_BEAM, SLAM, DRAGONBREATH
	db 50, KINGDRA, LEFTOVERS, SMOKESCREEN, SURF, HYPER_BEAM, DRAGONBREATH
	db -1 ; end
...
BrockGroup:
	...
	db "BROCK@"
	; TRAINERTYPE_ITEM_MOVES
	db  5, OMASTAR,    LEFTOVERS, BITE, SURF, PROTECT, SPIKE_CANNON
	db -1 ; end

	; BROCK (2)
	db "BROCK@"
	; TRAINERTYPE_ITEM_MOVES
	db  5, KABUTOPS,   LEFTOVERS, SLASH, SURF, ENDURE, GIGA_DRAIN
	db -1 ; end

	; BROCK (3)
	db "BROCK@"
	; TRAINERTYPE_ITEM_MOVES
	db  2, OMASTAR,    LEFTOVERS, BITE, SURF, PROTECT, SPIKE_CANNON
	db  2, KABUTOPS,   LEFTOVERS, SLASH, SURF, ENDURE, GIGA_DRAIN
	db -1 ; end
...
MistyGroup:
	...
	db "MISTY@"
	; TRAINERTYPE_ITEM_MOVES
	db  5, STARMIE,    LEFTOVERS, SURF, CONFUSE_RAY, RECOVER, ICE_BEAM
	db -1 ; end
...
LtSurgeGroup:
	...
	db "LT.SURGE@"
	; TRAINERTYPE_ITEM_MOVES
	db  5, ELECTABUZZ, LEFTOVERS, QUICK_ATTACK, THUNDERPUNCH, LIGHT_SCREEN, THUNDER
	db -1 ; end
...
ErikaGroup:
	...
	db "ERIKA@"
	; TRAINERTYPE_ITEM_MOVES
	db  5, VICTREEBEL, LEFTOVERS, SUNNY_DAY, SYNTHESIS, ACID, RAZOR_LEAF
	db -1 ; end
...
JanineGroup:
	...
	db "JANINE@"
	; TRAINERTYPE_ITEM_MOVES
	db  3, VENOMOTH,   LEFTOVERS, FORESIGHT, DOUBLE_TEAM, GUST, PSYCHIC_M
	db -1 ; end
...
SabrinaGroup:
	...
	db "SABRINA@"
	; TRAINERTYPE_ITEM_MOVES
	db  2, ALAKAZAM,   LEFTOVERS, RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db -1 ; end

	; SABRINA (2)
	db "SABRINA@"
	; TRAINERTYPE_ITEM_MOVES
	db  3, ALAKAZAM,   LEFTOVERS, RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db -1 ; end

	; SABRINA (3)
	db "SABRINA@"
	; TRAINERTYPE_ITEM_MOVES
	db  4, ALAKAZAM,   LEFTOVERS, RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db -1 ; end

	; SABRINA (4)
	db "SABRINA@"
	; TRAINERTYPE_ITEM_MOVES
	db  5, ALAKAZAM,   LEFTOVERS, RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db -1 ; end
...
BlaineGroup:
	...
	db "BLAINE@"
	; TRAINERTYPE_MOVES
	db  2, RAPIDASH,   LEFTOVERS, QUICK_ATTACK, FIRE_SPIN, FURY_ATTACK, FIRE_BLAST
	db -1 ; end

	; BLAINE (2)
	db "BLAINE@"
	; TRAINERTYPE_MOVES
	db  3, RAPIDASH,   LEFTOVERS, QUICK_ATTACK, FIRE_SPIN, FURY_ATTACK, FIRE_BLAST
	db -1 ; end

	; BLAINE (3)
	db "BLAINE@"
	; TRAINERTYPE_MOVES
	db  4, RAPIDASH,   LEFTOVERS, QUICK_ATTACK, FIRE_SPIN, FURY_ATTACK, FIRE_BLAST
	db -1 ; end

	; BLAINE (4)
	db "BLAINE@"
	; TRAINERTYPE_MOVES
	db  5, RAPIDASH,   LEFTOVERS, QUICK_ATTACK, FIRE_SPIN, FURY_ATTACK, FIRE_BLAST
	db -1 ; end
...
BlueGroup:
	...
	db "BLUE@"
	; TRAINERTYPE_ITEM_MOVES
	db  5, PIDGEOT,    LEFTOVERS, QUICK_ATTACK, WHIRLWIND, WING_ATTACK, MIRROR_MOVE
	;db 50, ALAKAZAM,   LEFTOVERS, DISABLE, RECOVER, PSYCHIC_M, REFLECT
	;db 50, RHYDON,     LEFTOVERS, FURY_ATTACK, SANDSTORM, ROCK_SLIDE, EARTHQUAKE
	;db 50, GYARADOS,   LEFTOVERS, TWISTER, HYDRO_PUMP, RAIN_DANCE, HYPER_BEAM
	;db 50, EXEGGUTOR,  LEFTOVERS, SUNNY_DAY, LEECH_SEED, EGG_BOMB, SOLARBEAM
	;db 50, ARCANINE,   LEFTOVERS, ROAR, SWIFT, FLAMETHROWER, EXTREMESPEED
	db -1 ; end

	; BLUE (2)
	db "BLUE@"
	; TRAINERTYPE_ITEM_MOVES
	;db 50, PIDGEOT,    LEFTOVERS, QUICK_ATTACK, WHIRLWIND, WING_ATTACK, MIRROR_MOVE
	db  5, ALAKAZAM,   LEFTOVERS, DISABLE, RECOVER, PSYCHIC_M, REFLECT
	;db 50, RHYDON,     LEFTOVERS, FURY_ATTACK, SANDSTORM, ROCK_SLIDE, EARTHQUAKE
	;db 50, GYARADOS,   LEFTOVERS, TWISTER, HYDRO_PUMP, RAIN_DANCE, HYPER_BEAM
	;db 50, EXEGGUTOR,  LEFTOVERS, SUNNY_DAY, LEECH_SEED, EGG_BOMB, SOLARBEAM
	;db 50, ARCANINE,   LEFTOVERS, ROAR, SWIFT, FLAMETHROWER, EXTREMESPEED
	...
	;db 50, PIDGEOT,    LEFTOVERS, QUICK_ATTACK, WHIRLWIND, WING_ATTACK, MIRROR_MOVE
	;db 50, ALAKAZAM,   LEFTOVERS, DISABLE, RECOVER, PSYCHIC_M, REFLECT
	db  5, RHYDON,     LEFTOVERS, FURY_ATTACK, SANDSTORM, ROCK_SLIDE, EARTHQUAKE
	;db 50, GYARADOS,   LEFTOVERS, TWISTER, HYDRO_PUMP, RAIN_DANCE, HYPER_BEAM
	;db 50, EXEGGUTOR,  LEFTOVERS, SUNNY_DAY, LEECH_SEED, EGG_BOMB, SOLARBEAM
	;db 50, ARCANINE,   LEFTOVERS, ROAR, SWIFT, FLAMETHROWER, EXTREMESPEED
	db -1 ; end
	...
	;db 50, ALAKAZAM,   LEFTOVERS, DISABLE, RECOVER, PSYCHIC_M, REFLECT
	;db 50, RHYDON,     LEFTOVERS, FURY_ATTACK, SANDSTORM, ROCK_SLIDE, EARTHQUAKE
	db  5, GYARADOS,   LEFTOVERS, TWISTER, HYDRO_PUMP, RAIN_DANCE, HYPER_BEAM
	;db 50, EXEGGUTOR,  LEFTOVERS, SUNNY_DAY, LEECH_SEED, EGG_BOMB, SOLARBEAM
	;db 50, ARCANINE,   LEFTOVERS, ROAR, SWIFT, FLAMETHROWER, EXTREMESPEED
	db -1 ; end
...
WillGroup:
	...
	db "WILL@"
	; TRAINERTYPE_ITEM_MOVES
	db 40, XATU,       LEFTOVERS, QUICK_ATTACK, FUTURE_SIGHT, CONFUSE_RAY, PSYCHIC_M
	;db 41, JYNX,       LEFTOVERS, DOUBLESLAP, LOVELY_KISS, ICE_PUNCH, PSYCHIC_M
	;db 41, EXEGGUTOR,  LEFTOVERS, REFLECT, LEECH_SEED, EGG_BOMB, PSYCHIC_M
	;db 41, SLOWBRO,    LEFTOVERS, CURSE, AMNESIA, BODY_SLAM, PSYCHIC_M
	;db 42, XATU,       LEFTOVERS, QUICK_ATTACK, FUTURE_SIGHT, CONFUSE_RAY, PSYCHIC_M
	db -1 ; end
...
KogaGroup:
	...
	db "KOGA@"
	; TRAINERTYPE_ITEM_MOVES
	db 40, ARIADOS,    LEFTOVERS, DOUBLE_TEAM, SPIDER_WEB, BATON_PASS, GIGA_DRAIN
	;db 41, VENOMOTH,   LEFTOVERS, SUPERSONIC, GUST, PSYCHIC_M, TOXIC
	;db 43, FORRETRESS, LEFTOVERS, PROTECT, SWIFT, EXPLOSION, SPIKES
	;db 42, MUK,        LEFTOVERS, MINIMIZE, ACID_ARMOR, SLUDGE_BOMB, TOXIC
	;db 44, CROBAT,     LEFTOVERS, DOUBLE_TEAM, QUICK_ATTACK, WING_ATTACK, TOXIC
	db -1 ; end
...
BrunoGroup:
	...
	db "BRUNO@"
	; TRAINERTYPE_ITEM_MOVES
	db 42, HITMONTOP,  LEFTOVERS, PURSUIT, QUICK_ATTACK, DIG, DETECT
	;db 42, HITMONLEE,  LEFTOVERS, SWAGGER, DOUBLE_KICK, HI_JUMP_KICK, FORESIGHT
	;db 42, HITMONCHAN, LEFTOVERS, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
	;db 43, ONIX,       LEFTOVERS, BIND, EARTHQUAKE, SANDSTORM, ROCK_SLIDE
	...
	;db 42, HITMONLEE,  LEFTOVERS, SWAGGER, DOUBLE_KICK, HI_JUMP_KICK, FORESIGHT
	;db 42, HITMONCHAN, LEFTOVERS, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
	db 43, STEELIX,    LEFTOVERS, BIND, EARTHQUAKE, SANDSTORM, ROCK_SLIDE
	;db 46, MACHAMP,    LEFTOVERS, ROCK_SLIDE, FORESIGHT, VITAL_THROW, CROSS_CHOP
	db -1 ; end
...
KarenGroup:
	...
	db "KAREN@"
	; TRAINERTYPE_ITEM_MOVES
	db 42, UMBREON,    LEFTOVERS, SAND_ATTACK, CONFUSE_RAY, FAINT_ATTACK, MEAN_LOOK
	;db 42, VILEPLUME,  LEFTOVERS, STUN_SPORE, ACID, MOONLIGHT, PETAL_DANCE
	;db 45, GENGAR,     LEFTOVERS, LICK, SPITE, CURSE, DESTINY_BOND
	;db 44, MURKROW,    LEFTOVERS, QUICK_ATTACK, WHIRLWIND, PURSUIT, FAINT_ATTACK
	;db 47, HOUNDOOM,   LEFTOVERS, ROAR, PURSUIT, FLAMETHROWER, CRUNCH
	db -1 ; end
...
ChampionGroup:
	...
	db "LANCE@"
	; TRAINERTYPE_ITEM_MOVES
	db 44, GYARADOS,   LEFTOVERS, FLAIL, RAIN_DANCE, SURF, HYPER_BEAM
	;db 47, DRAGONITE,  LEFTOVERS, THUNDER_WAVE, TWISTER, THUNDER, HYPER_BEAM
	;db 47, DRAGONITE,  LEFTOVERS, THUNDER_WAVE, TWISTER, BLIZZARD, HYPER_BEAM
	;db 46, AERODACTYL, LEFTOVERS, WING_ATTACK, ANCIENTPOWER, ROCK_SLIDE, HYPER_BEAM
	;db 46, CHARIZARD,  LEFTOVERS, FLAMETHROWER, WING_ATTACK, SLASH, HYPER_BEAM
	;db 50, DRAGONITE,  LEFTOVERS, FIRE_BLAST, SAFEGUARD, OUTRAGE, HYPER_BEAM
	db -1 ; end
...
RedGroup:
	...
	db "RED@"
	; TRAINERTYPE_ITEM_MOVES
	db 50, PIKACHU,    LEFTOVERS, CHARM, QUICK_ATTACK, THUNDERBOLT, THUNDER
	;db 50, ESPEON,     LEFTOVERS, MUD_SLAP, REFLECT, SWIFT, PSYCHIC_M
	;db 50, SNORLAX,    LEFTOVERS, AMNESIA, SNORE, REST, BODY_SLAM
	;db 50, VENUSAUR,   LEFTOVERS, SUNNY_DAY, GIGA_DRAIN, SYNTHESIS, SOLARBEAM
	;db 50, CHARIZARD,  LEFTOVERS, FLAMETHROWER, WING_ATTACK, SLASH, FIRE_SPIN
	;db 50, BLASTOISE,  LEFTOVERS, RAIN_DANCE, SURF, BLIZZARD, WHIRLPOOL
	db -1 ; end
...
MysticalmanGroup:
	...
	db "EUSINE@"
	; TRAINERTYPE_ITEM_MOVES
	db 50, HYPNO,       LEFTOVERS, DREAM_EATER, HYPNOSIS, DISABLE, CONFUSION
	;db 50, GENGAR,      LEFTOVERS, LICK, HYPNOSIS, MEAN_LOOK, CURSE
	;db 50, ELECTRODE,   LEFTOVERS, SCREECH, SONICBOOM, THUNDER, ROLLOUT
	;db 50, JUMPLUFF,    LEFTOVERS, SCREECH, SONICBOOM, THUNDER, ROLLOUT
	db -1 ; end
