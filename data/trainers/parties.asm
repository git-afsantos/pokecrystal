...
BrockGroup:
	...
	db "BROCK@"
	; TRAINERTYPE_ITEM_MOVES
	db 42, OMASTAR,    LEFTOVERS, BITE, SURF, PROTECT, SPIKE_CANNON
	db 42, KABUTOPS,   LEFTOVERS, SLASH, SURF, ENDURE, GIGA_DRAIN
	db -1 ; end
...
MistyGroup:
	...
	db "MISTY@"
	; TRAINERTYPE_ITEM_MOVES
	db 47, STARMIE,    LEFTOVERS, SURF, CONFUSE_RAY, RECOVER, ICE_BEAM
	db -1 ; end
...
LtSurgeGroup:
	...
	db "LT.SURGE@"
	; TRAINERTYPE_ITEM_MOVES
	db 46, ELECTABUZZ, LEFTOVERS, QUICK_ATTACK, THUNDERPUNCH, LIGHT_SCREEN, THUNDER
	db -1 ; end
...
ErikaGroup:
	...
	db "ERIKA@"
	; TRAINERTYPE_ITEM_MOVES
	db 46, VICTREEBEL, LEFTOVERS, SUNNY_DAY, SYNTHESIS, ACID, RAZOR_LEAF
	db -1 ; end
...
JanineGroup:
	...
	db "JANINE@"
	; TRAINERTYPE_ITEM_MOVES
	db 39, VENOMOTH,   LEFTOVERS, FORESIGHT, DOUBLE_TEAM, GUST, PSYCHIC_M
	db -1 ; end
...
SabrinaGroup:
	...
	db "SABRINA@"
	; TRAINERTYPE_ITEM_MOVES
	db 48, ALAKAZAM,   LEFTOVERS, RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db -1 ; end
...
BlaineGroup:
	...
	db "BLAINE@"
	; TRAINERTYPE_MOVES
	db 50, RAPIDASH,   LEFTOVERS, QUICK_ATTACK, FIRE_SPIN, FURY_ATTACK, FIRE_BLAST
	db -1 ; end
